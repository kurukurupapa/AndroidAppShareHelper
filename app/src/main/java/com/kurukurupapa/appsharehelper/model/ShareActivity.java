 ...
 * 共有アクティビティデータ
 *
 * 受信したインテントを、別アプリのアクティビティへ転送するためのデータです。
 */
public class ShareActivity implements BaseColumns {
    public static final String TABLE_NAME = "share_activity";
    ...
    public ContentValues createContentValues() {
        ...
        values.put(COLUMN_STANDARD_FLAG, mStandardFlag ? 1: 0);
        return values;
    }
}
